...
LABEL "splunk-appinspect-version"="1.6.0"
...
COPY splunk-appinspect-1.6.0.tar.gz /home/downloads/splunk-appinspect-1.6.0.tar.gz
RUN pip install /home/downloads/splunk-appinspect-1.6.0.tar.gz
